    ...
    public static function rules()
    {
        return
            [
                ...
                'fecha_nacimiento' => 'date|before:date',
                'edad' => 'required|integer',
                'meses' => 'integer|max:12',
    ...
    public static function messages()
    {
        return
            [
                ...
                'fecha_nacimiento.before' => 'Ingrese una fecha válida',
                'edad.integer' => 'Ingrese un valos númerico',
                'edad.required' => 'La edad es requerida',
                'meses.required' => 'Ingrese un valor númerico',
